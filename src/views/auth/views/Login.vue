...
export default {
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      if (res) {
        this.$router.push(res.guard == "user" ? "/" : "/admin");
      }
    },
  },
};
...
<template>
  <div class="page">
    ...
    <section class="ftco-section bg-dark">
      <div class="container">
        <h2 class="subheading text-center royal__talent">LOGIN</h2>
        <form @submit.prevent="onSubmit">
          <div class="row mb-2">
            <div class="col-12 mx-auto mb-5">
              <input
                type="email"
                class="w-50 mx-auto form-control"
                placeholder="Email"
                aria-label="Email"
          ...
          <div class="row mb-5">
            <div class="col-12 text-center">
              <button
                type="submit"
                class="w-25 mx-auto btn btn-primary py-3 px-4 mt-5"
              >
                Sign In
              </button>
            </div>
